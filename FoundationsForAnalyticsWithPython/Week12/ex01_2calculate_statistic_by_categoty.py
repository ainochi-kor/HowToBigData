...
input_file = 'csv/customer_category_history.csv'
output_file = 'csv/ex01_output.csv'

packages = {}
previous_name = 'N/A' #Name
previous_package = 'N/A' #Category
previous_package_date = 'N/A' #Date
first_row = True
today = date.today().strftime('%m/%d/%Y') #오늘 날짜
